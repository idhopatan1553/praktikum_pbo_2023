...
public class Main {
    public static void main(String[] args) {
        // Membuat objek AkatsukiMember pertama
        AkatsukiMember nagato = new AkatsukiMember("Uzumaki Nagato", "Uzumaki", "Shinra tensei, Chibaku tensei", 0, "Rei", "Meninggal");

        // Menampilkan profil Nagato
        ...
        // Membuat objek AkatsukiMember kedua
        AkatsukiMember obito = new AkatsukiMember("Uchiha Obito", "Uchiha", "Izanagi", 28, "Virgo", "Masih Hidup");

        // Menampilkan profil Obito
